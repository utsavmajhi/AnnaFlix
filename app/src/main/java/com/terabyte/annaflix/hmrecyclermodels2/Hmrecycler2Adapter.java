package com.terabyte.annaflix.hmrecyclermodels2;
...
public class Hmrecycler2Adapter extends RecyclerView.Adapter<Hmrecycler2Adapter.AnimeViewHolder> {
    public Hmrecycler2Adapter(Context mContext, ArrayList<hmrecycleranimeitemModel> mallanimeitemlist) {
        this.mContext = mContext;
        this.mallanimeitemlist = mallanimeitemlist;
    }

    Context mContext;
    private ArrayList<hmrecycleranimeitemModel> mallanimeitemlist;
    @NonNull
    @Override
    ...
    public void onBindViewHolder(@NonNull AnimeViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                hmrecycleranimeitemModel m=mallanimeitemlist.get(position);
